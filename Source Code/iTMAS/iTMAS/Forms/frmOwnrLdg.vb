Public Class frmOwnrLdg
    ...
    Private Sub frmOwnrLdg_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        gUObj = 20
        If lAcc Then
            PopulateOwners()
        End If
    ...
    Private Sub frmOwnrLdg_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        gUObj = 20
    ...
    Private Sub frmOwnrLdg_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
